struct PhoneTrackingParams
  ...
  testing_delay::Float64
end

PhoneTrackingParams(N::Integer, detection_prob::Real=1.0, detection_delay::Real=0.5, testing_delay::Real=1.5) = 
    PhoneTrackingParams(BitVector(undef, N), detection_prob, detection_delay, testing_delay)
