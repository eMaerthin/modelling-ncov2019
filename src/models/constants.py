...
PER_DAY_INCREASE = 'per_day_increase'
MEMORY_USE = 'memory_use'
ACTIVE_PEOPLE = 'active_people'
DEATHS = 'deaths'
SWITCH_T = 'switch_t'
NEW_R = 'new_r'
CONSTANT_TWO_GROUPS = 'constant_two_groups'
...
DAYS_WITH_INCREASING_ACTIVE_CASES = 'days_with_increasing_active_cases'
STOP_SIMULATION_THRESHOLD = 'stop_simulation_threshold'
STOP_SIMULATION_THRESHOLD_TYPE = 'stop_simulation_threshold_type'
STOP_SIMULATION_CRITERIA = 'stop_simulation_criteria' # designed to support more stop simulation critera; use exclusively with ...THRESHOLD and ...THRESHOLD_TYPE
...
DAYS_WITHOUT_NEW_DETECTIONS = 'days_without_new_detections'
